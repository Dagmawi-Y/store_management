...
<body>
   <div class="side-menu" style="margin-left:0 !important">
        ...
        <ul>
            ...
            <li><a href="add.php"><img src="add.png" alt="">&nbsp;<span>Add Item</span> </a></li>
			<li style="background-color:white"><a  href="#"><img src="request.png" alt="">&nbsp;<span>View Review</span> </a></li>
...
<div class="container">
   <h1 style="color: #e7a33c;" class="page-header text-center">Request History</h1>
						...
						<?php
							...
							while($row = mysqli_fetch_assoc($query)){
								...
								"<tr>
									...
									<td>".$row['Status']."</td>
									<td>
										<a style='background-color:#3a7eec' href='#edit_".$row['id']."' class='btn btn-success btn-sm' data-toggle='modal'><span class=''></span>Approve/Reject</a>
										</td>
								</tr>";
								include('approve_reject_form.php');
							}
