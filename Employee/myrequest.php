...
<body>
   <div class="side-menu" style="margin-left:0 !important">
        ...
        <ul>
			...
			<li style="background-color:white"><a  href="#"><img src="request.png" alt="">&nbsp;<span>My Request</span> </a></li>
...
<div class="container">
   <h1 style="color: #e7a33c;" class="page-header text-center">My Request History</h1>
